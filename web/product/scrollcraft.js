/* ============================================================================
   ...
   Copyright (c) 2026 Nate Herk — MIT License, full text in
   SCROLLCRAFT-LICENSE.txt. Unmodified from github.com/nateherkai/scroll-craft;
   this project themes it with tokens (product/site.css) rather than editing it.
   ----------------------------------------------------------------------------
